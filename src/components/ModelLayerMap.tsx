...
const labels = { gqa: 'Full / GQA', mha: 'Full / MHA', mla: 'MLA', gdn: 'Gated DeltaNet', swa: 'Sliding / GQA', 'window-mqa': 'SWA-only MQA', csa: 'SWA + CSA', hca: 'SWA + HCA' }
const colors = { gqa: 'border-cyan-200/35 bg-cyan-200/10 text-cyan-100', mha: 'border-blue-200/35 bg-blue-200/10 text-blue-100', mla: 'border-violet-200/35 bg-violet-200/10 text-violet-100', gdn: 'border-lime-200/35 bg-lime-200/10 text-lime-100', swa: 'border-amber-200/35 bg-amber-200/10 text-amber-100', 'window-mqa': 'border-cyan-200/35 bg-cyan-200/10 text-cyan-100', csa: 'border-violet-200/35 bg-violet-200/10 text-violet-100', hca: 'border-rose-200/35 bg-rose-200/10 text-rose-100' }
