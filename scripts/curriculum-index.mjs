...
function extractTitle(content, relativePath) {
    if (relativePath.endsWith('.md')) {
        ...
        if (heading)
            return cleanInlineMarkdown(heading);
    }
...
export function buildCurriculumIndex(contentModules) {
    ...
    const draftArticles = [...localizedContent.entries()]
        ...
        return {
            ...
            availableLanguages: ['zh', 'en'].filter((language) => content[language] !== undefined),
            tags: route.tags,
